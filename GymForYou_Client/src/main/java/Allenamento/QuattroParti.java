...
public class QuattroParti extends PartiCorpo implements Interfaccia{

    @Override
    public Map assegnaEsercizi(Esercizio product) {
        
        for (int i = 0; i < product.getSize(); i++) {
            if (i >= (product.getSize()-8)) {
                    ...
                    case 9:
                        if (!product.getTipo().equals("Scheda Personalizzata")) {
                            ...
                            if (i<=3) {
                                ...
                                schedaPersonalizzata(i, 3, 2, product.getTipo(), product.getShuffle(), product.getListaEsercizi(), product.getListaPartiCorpo(), product.getListaMetRep());
                            }else if(i>6 && i <= 8 ){
