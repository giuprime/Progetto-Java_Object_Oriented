...
public class DueParti extends PartiCorpo implements Interfaccia{
    ...
    public Map assegnaEsercizi(Esercizio product) {
        ...
        for (int j = 0; j < product.getListaMomenti().size(); j = j+3) {
            ...
            for (int i = 1; i <= numeroEsercizi; i++) {
                //System.out.println("numeroEsercizi "+ numeroEsercizi);--> RESTITUISCE IL NUMERO DI ESERCIZI DA FARE
